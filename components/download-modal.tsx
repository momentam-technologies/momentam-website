        ...
        >
          ...
          <div className="text-center mb-8">
            <div className="bg-gray-50 rounded-xl p-6 mb-4 inline-block">
              <Image
                src={generateSmartQRCodeUrl(200)}
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-gray-600">
                This QR code automatically detects your device and takes you to the right app store
              </p>
            </div>
          </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600">
                  Open your phone's camera app and point it at the QR code. Tap the notification that appears to download the app from your device's app store.
                </p>
              </div>
            </div>
          </div>
